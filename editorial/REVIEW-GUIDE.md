...
- Put a word or phrase in quotation marks when discussing it as language: "What does 'studies' mean here?" Apply this in instructions and explanatory feedback, not to ordinary uses in the example sentence. Use double quotation marks around a target containing an apostrophe when that improves readability. A reference such as "What does she mean?" does not need quotation marks.
