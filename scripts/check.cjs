...
assert(levelCheckHtml.includes('id="meterIncorrect"') && levelCheckHtml.includes('id="meterCorrect"'), 'Level check needs red and green result meter segments');
assert(practiceHtml.includes('id="practiceMeterIncorrect"') && practiceHtml.includes('id="practiceMeterCorrect"'), 'Practice needs red and green result meter segments');
