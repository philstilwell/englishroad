  ...
  window.createEnglishRoadItemData = function createEnglishRoadItemData({ pick, item }) {
    ...
    const blueprints = [
      ...
      },
      {
        ...
        make: (i) => {
          const examples = [
            ["Choose the sentence with correct grammar.", "The data collected during the trial support the original hypothesis.", "The data which it was collected during the trial support the original hypothesis.", "The data collecting during the trial support the original hypothesis.", "The data collected during the trial supporting the original hypothesis."],
            ["Choose the sentence with correct grammar.", "The forms submitted after Friday require special approval.", "The forms which they were submitted after Friday require special approval.", "The forms submitting after Friday require special approval.", "The forms submitted after Friday requiring special approval."],
            ["Choose the sentence with correct grammar.", "The notes written during the meeting explain the decision.", "The notes which they were written during the meeting explain the decision.", "The notes writing during the meeting explain the decision.", "The notes written during the meeting explaining the decision."],
            ["Choose the sentence with correct grammar.", "The emails sent before noon reached every participant.", "The emails which they were sent before noon reached every participant.", "The emails sending before noon reached every participant.", "The emails sent before noon reaching every participant."],
            ["Choose the sentence with correct grammar.", "The survey completed by the students shows clear progress.", "The survey which it completed by the students shows clear progress.", "The survey completing by the students shows clear progress.", "The survey completed by the students showing clear progress."],
            ["Choose the sentence with correct grammar.", "The schedule posted near the door lists all room changes.", "The schedule which it was posted near the door lists all room changes.", "The schedule posting near the door lists all room changes.", "The schedule posted near the door listing all room changes."],
            ["Choose the sentence with correct grammar.", "The chart prepared for the lesson compares two answers.", "The chart which it was prepared for the lesson compares two answers.", "The chart preparing for the lesson compares two answers.", "The chart prepared for the lesson comparing two answers."],
            ["Choose the sentence with correct grammar.", "The rules printed on the card apply to all visitors.", "The rules which they were printed on the card apply to all visitors.", "The rules printing on the card apply to all visitors.", "The rules printed on the card applying to all visitors."]
          ];
          const ex = pick(examples, i);
